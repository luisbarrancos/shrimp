...
class TiXmlBase
{
  ...
  protected:
    ...
    {
      public:
        explicit StringToBuffer(const TIXML_STRING& str);
        ~StringToBuffer();
        char* buffer;
    };
...
class TiXmlAttribute : public TiXmlBase
{
  ...
  public:
	...
	*/
    ...
    void StreamOut(TIXML_OSTREAM* out) const override;
    // [internal use]
...
class TiXmlText : public TiXmlNode
{
  ...
  public:
    ...
    */
    explicit TiXmlText(const char* initValue)
...
class TiXmlDocument : public TiXmlNode
{
  ...
  private:
    ...
    bool
        useMicrosoftBOM{}; // the UTF-8 BOM were found when read. Note this, and try to write.
};
