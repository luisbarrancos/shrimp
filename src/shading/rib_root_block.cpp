...
std::string rib_root_block::build_shader_file (const shader_t ShaderType, const std::string& ShaderName) {
	...
	shader_code += "/*  $Revision$  */\n\n";
	shader_code += "/* Author(s):\n";
	shader_code += m_scene->authors() + "\n";
	shader_code += "*/\n";
	shader_code += "/* Scene name:\n";
	shader_code += m_scene->name() + "\n";
	shader_code += "*/\n";
	shader_code += "/* Scene description:\n";
	shader_code += m_scene->description() + "\n";
	shader_code += "*/\n";
