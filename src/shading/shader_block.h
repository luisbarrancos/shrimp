...
{
  public:
    explicit property(std::string Name, std::string Description = "");
...
using storages_t = std::vector<std::string>;
storages_t get_property_storage_types();

using array_types_t = std::vector<std::string>;
...
class shader_block : block
{
  ...
  public:
    ...
    void add_input(
        ...
        const bool ShaderParameter = true);
    ...
    bool set_output_type_extension(
        const std::string& Name,
        const std::string& TypeExtension);
    ...
    bool set_input_multi_operator_parent(
        const std::string& Name,
        const std::string& Parent);

    void get_multi_input_child_list(
        const std::string& Name,
    ...
    void reset_code_written()
    {
        m_code_written = false;
    }
    std::string get_code() const;
    bool code_written() const
    {
        return m_code_written;
    }
