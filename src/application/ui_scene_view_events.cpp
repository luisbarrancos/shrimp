...
void scene_view::mouse_wheel_update(double move)
{
...
void scene_view::mouse_any_button_down()
{
...
void scene_view::mouse_left_button_down()
{
...
void scene_view::mouse_right_button_down()
{
...
void scene_view::mouse_any_button_drag()
{
	m_current_mouse_x = fltk::event_x();
	m_current_mouse_y = fltk::event_y();
}
...
void scene_view::mouse_left_button_drag()
{
...
void scene_view::mouse_left_button_release()
{
	const bool shift_key_down = fltk::event_state (fltk::SHIFT);
	const bool ctrl_key_down = fltk::event_state (fltk::CTRL);
